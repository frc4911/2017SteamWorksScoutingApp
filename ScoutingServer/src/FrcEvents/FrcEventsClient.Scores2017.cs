...
namespace Org.USFirst.Frc.Team4911.FrcEvents
{
    ...
    {
        /// <summary>
        /// Gets the 2017 match results for all matches of a particular event.
        /// </summary>
        ...
        public async Task<IEnumerable<MatchScores2017>> GetScores2017(string eventCode, TournamentLevel tournamentLevel)
        {
            const int season = 2017;
            ...
            return await GetScores2017(path);
        }

        /// <summary>
        /// Gets the 2017 match results for all matches of a particular event and particular team.
        /// </summary>
        /// <param name="eventCode">Case insensitive alphanumeric eventCode of the event from which the alliance selection results are requested. Must be at least 3 characters.</param>
        /// <param name="tournamentLevel">Tournament Level of desired match results.</param>
        ...
        public async Task<IEnumerable<MatchScores2017>> GetScores2017(string eventCode, TournamentLevel tournamentLevel, int teamNumber)
        {
            const int season = 2017;
            eventCode = Validation.EnsureEventCode(eventCode);
        ...
        /// <summary>
        /// Gets the 2017 match results for a particular match of a particular event.
        /// </summary>
        /// <param name="eventCode">Case insensitive alphanumeric eventCode of the event from which the alliance selection results are requested. Must be at least 3 characters.</param>
        /// <param name="matchNumber">single matchNumber of result. Example</param>
        /// <param name="tournamentLevel">Tournament Level of desired match results.</param>
        public async Task<IEnumerable<MatchScores2017>> GetScores2017(string eventCode, int matchNumber, TournamentLevel tournamentLevel)
        {
            const int season = 2017;
            eventCode = Validation.EnsureEventCode(eventCode);
            if (matchNumber < 1)
        ...
        /// <summary>
        /// Gets a range of 2017 match results for a particular event.
        /// </summary>
        /// <param name="eventCode">Case insensitive alphanumeric eventCode of the event from which the alliance selection results are requested. Must be at least 3 characters.</param>
        ...
        /// <param name="tournamentLevel">Tournament Level of desired match results.</param>
        public async Task<IEnumerable<MatchScores2017>> GetScores2017(string eventCode, int startMatchNumber, int endMatchNumber, TournamentLevel tournamentLevel)
        {
            var season = 2017;
            eventCode = Validation.EnsureEventCode(eventCode);
